...
$(document).ready(function () {
      ...
      success: function (res) {
        ...
        $(".card .list").on("click", (e) => {
          ...
          if (
            ...
            $($(e)[0].target).attr("data-listidx") == 2 &&

            $($(e)[0].target).attr("data-listurl") == 2
            ...
            window.location.href = `./question/question_a0${
              ...
              Number($($(e)[0].target).attr("data-listidx")) + 1

            }&bigstep=${Number($($(e)[0].target).attr("data-listurl"))}`;
  ...
  $(".card .list").on("click", (e) => {
    ...
    if (
      ...
      $($(e)[0].target).attr("data-listidx") == 3 &&
      ...
      }.html?workOrderID=${params.workOrderID}&step=${

        Number($($(e)[0].target).attr("data-listidx"))
      ...
      success: function (res) {
        ...
        if (res.returnCode) {
          ...
          $(res.returnData.item).each((idx, e) => {
            ...
            $(`[data-cardidx=${idx+1}] .g-container .text`).html(
            ...
            $(e.item).each((idxx, ee) => {
              ...
              if (ee.if_complete) {
                ...
                $(
                  ...
                  $(`[data-cardidx=${idx+1}] [data-listidx=${idxx+1}] img`)[0]
