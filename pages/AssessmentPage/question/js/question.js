      ...
      success: function (res) {
        ...
        if (res.returnCode) {
          ...
          $("#coachA").val(
            ...
            `${res.returnData.item[paramBigStep].item[0].item[0].value[0]}`

          );

          $("#coachB").val(

            `${res.returnData.item[paramBigStep].item[0].item[0].value[1]}`
  ...
  $(".next").on("click", function () {
    ...
    if (step == "01") {
      ...
      let newData = [
        ...
        { value: [$("input[name='emoji']:checked").val()] },
      ...
      $("input[name='diagnosis']:checked").each((idx, e) => {
        ...
        let subDiagnosisValue = subDiagnosisType==='text' ? subDiagnosis.val() : $(`input[name='sub_diagnosis${diagnosisValue}']:checked`).val();
      ...
      let newData = [
        ...
        { value: [$("#step06text01").val()] },

        { value: {} },

        { value: [$("#step06text02").val()] },
      ...
      $("input[name='history']:checked").each((idx, e) => {
        ...
        let subHistoryValue = subHistoryType==='text' ? subHistory.val() : $(`input[name='sub_history${historyValue}']:checked`).val();
